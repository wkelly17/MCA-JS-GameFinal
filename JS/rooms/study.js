...
let study = {
  ...
  $officeChair: {
    name: '$officeChair',
    nodes: null,
    selector: '[data-selector = "officeChair"]',
    listenerType: 'click',
    inspected: false,
    gameMessageWhenInspecting: 'Wheeeee!',
    gameMessageWhenUninspecting: 'Wheeeee again!',
    fxn: inspect,
  },
  $officeTrashCan: {
    name: '$officeTrashCan',
    nodes: null,
    selector: '[data-selector = "officeTrashCan"]',
    listenerType: 'click',
    inspected: false,
    gameMessageWhenInspecting: "Let's look in the trash can",
    gameMessageWhenUninspecting: 'Oh, it stinks a little',
    fxn: inspect,
  },
};
